...
formula1=[1 0 0 0];     %defect type 1, containing 1 vacancy, no H and D
C1=0e-6;                %concentration of defect type 1 
formula2=[0 0 1 0];     %defect type 2, containing no vacancy, no H, 1 D
