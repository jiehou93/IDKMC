    ...
    allocate(para_table(8,para_range(1,1):para_range(1,2),para_range(2,1):para_range(2,2),para_range(3,1):para_range(3,2),para_range(4,1):para_range(4,2)))
    para_table=-100
    ...
    do i=1,file_lines-4                                                             !读取边界参数
        ...
        read(dummy_string,*)dummy_int(1:4),para_table(1:8,formula(1),formula(2),formula(3),formula(4))    !读取参数
    enddo
    close(1001)
